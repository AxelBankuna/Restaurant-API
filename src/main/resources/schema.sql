...
INSERT INTO RESTAURANTS(id,name,city,"STATE",zipcode,peanutAverage,eggAverage,dairyAverage,averageScore)
VALUES (1,'Pizza Place','New York','NY',10001,4.3,3.1,2.0,3.13);
